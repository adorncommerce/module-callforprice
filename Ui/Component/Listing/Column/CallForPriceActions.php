...
/**
 * Class CallForPriceActions
 * @package Adorncommerce\CallForPrice\Ui\Component\Listing\Column
 */
class CallForPriceActions extends Column
{
    ...
    /**
     * CallForPriceActions constructor.
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['id'])) {
                    ...
                    $item[$name]['delete'] = [
                        'href' => $this->urlBuilder->getUrl(self::CALLFORPRICE_URL_PATH_DELETE, ['id' => $item['id']]),
                        'label' => __('Delete'),
                        'confirm' => [
